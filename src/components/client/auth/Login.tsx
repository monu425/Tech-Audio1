...
import { LoginInput, loginSchema } from "@/validations/user.schema";
  ...
  return (
    <>
      <header className="flex items-center justify-between py-5">
        ...
        <Link
          href="/register"
          className=" rounded-lg border px-4 py-2 text-base font-medium transition-all duration-200 hover:bg-gray-100"
        >
          Register
        </Link>
      </header>
        ...
        <Card className="w-full max-w-md rounded-2xl shadow-lg border py-8">
          ...
          <CardContent className="space-y-4 sm:space-y-5">
            <form className="space-y-4" onSubmit={form.handleSubmit(onSubmit)}>
              ...
              {/* Forgot */}
              <div className="text-right text-sm sm:text-base pb-2">
